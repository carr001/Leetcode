...
//ͬ쳲��������ؼ��������ǣ������numWays(n)ת��Ϊ���numWays(n-1)��numWays(n-2)
int numWays(int n) {
    if (n <= 1) return 1;
    int dp[100 + 1];
    dp[0] = 1;
...
vector<vector<int>> levelOrder3(TreeNode* root) {
    ...
    while (!q.empty()) {
        int size = q.size();
        vector<int> subRes;
        stack<TreeNode*>s;// ���Բ���ջ��ֱ��reverse
        while (size) {
            size--;
            TreeNode* t = q.front();q.pop();
            if(count%2==1)
...
bool isStraight(vector<int>& nums) {
    ...
    sort(nums.begin(),nums.end());// ���ʹ��hash����ô���ӿռ临�Ӷȣ�����ʱ�临�Ӷ�
...
pair<TreeNode*, int> subLowestCommonAncestor(TreeNode* root, TreeNode* p, TreeNode* q,int K) {
    ...
    if (K == 2) {
        if (root == p || root == q) {
            ...
            if (res.second == 1)
                return pair < TreeNode*, int>{root, 2};//��rootΪ���������ҵ�2��
            if (res.second == 0) {
                ...
                if (res2.second == 1) {
                    ...
                    return pair < TreeNode*, int>{NULL, 1};//��rootΪ��������ֻ�ҵ�1��
                }
            }
        }
